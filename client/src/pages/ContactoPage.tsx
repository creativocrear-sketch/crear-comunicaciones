      ...
      <section className="flex-1 bg-white py-20">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-16 items-start mb-12">
            ...
            >
              <p className="text-lg text-gray-600 mb-4">{t('hola mucho gusto', 'contact')}</p>
              <h2 className="text-4xl font-bold text-black mb-4">
                {t('mi nombre es', 'contact')} <span className="text-coral">Alexander</span>
              </h2>
              <p className="text-lg text-gray-600 leading-relaxed">
                {t('descripcion alexander', 'contact')}
              </p>
            </motion.div>
          </div>
          ...
          >
            <div>
              <h3 className="text-2xl font-bold text-black mb-6">{t('reserva tu cita', 'contact')}</h3>
            </div>
