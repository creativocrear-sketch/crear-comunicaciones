        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              Selecciona el plan que mejor se adapte a tus necesidades. Los
              precios se actualizarán próximamente.
            </p>
          </div>
          ...
          <div className="mt-12 max-w-3xl mx-auto text-center">
            <p className="text-gray-600 text-sm leading-relaxed">
              <span className="font-semibold text-black">Nota importante:</span> El precio que se relaciona es el valor unitario de cada SMS. Todos los valores más IVA. Precios para Colombia.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-navy/55 mb-8">
              Los precios varían según el volumen y el destino. Contáctanos para
              recibir una propuesta adaptada a tu empresa.
            </p>
