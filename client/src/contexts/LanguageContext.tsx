...
export const translations: Record<'es' | 'en', Translations> = {
  es: {
    ...
    privacy: {
      ...
      section3_1Content: 'La información proporcionada por los usuarios es tratada únicamente a través de las herramientas propias de Crear Comunicaciones y mediante plataformas de mensajería de Meta Platforms, Inc. (incluyendo WhatsApp, Messenger e Instagram), utilizadas para la gestión de las comunicaciones.\n\nCrear comunicaciones gestiona la información en calidad de negocio de ser un negocio aprobado como proveedor tecnológico de Meta, mientras que las plataformas de Meta procesan los datos conforme a sus propias políticas de privacidad y condiciones de uso.',
  ...
  en: {
    ...
    privacy: {
      ...
      section3_1Content: 'The information provided by users is treated exclusively through Crear Comunicaciones\' own tools and through Meta Platforms, Inc. messaging platforms (including WhatsApp, Messenger, and Instagram), used for communication management.\n\nCrear Comunicaciones manages the information as a business approved as a Meta technology provider, while Meta platforms process the data according to their own privacy policies and terms of use.',
