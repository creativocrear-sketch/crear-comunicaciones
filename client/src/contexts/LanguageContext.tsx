...
export const translations: Record<'es' | 'en', Translations> = {
  es: {
    ...
    services: {
      ...
      'pricing important note text': 'El precio que se relaciona es el valor unitario de cada email. Todos los valores más IVA. Precios para Colombia.',
  ...
  en: {
    ...
    services: {
      ...
      'pricing important note text': 'The listed price is the unit value of each email. All prices plus VAT. Prices for Colombia.',
