...
export const translations: Record<'es' | 'en', Translations> = {
  es: {
    ...
    blog: {
      ...
      'articulo 1 introduction': 'En el panorama digital actual, Instagram se ha consolidado como una de las plataformas de redes sociales más influyentes. Sin embargo, existe una confusión común entre muchos negocios y emprendedores: considerar a Instagram como una estrategia de marketing en sí misma. Este artículo desglosará por qué Instagram, y de hecho cualquier red social, debe ser vista como un canal dentro de una estrategia de marketing más amplia, y no como la estrategia completa.',
      'articulo 1 concepto 1 title': 'Instagram como Canal de Comunicación y Distribución',
      'articulo 1 concepto 1 description': 'Instagram ofrece herramientas poderosas para la comunicación visual, la interacción con la audiencia y la distribución de contenido. Permite mostrar productos, construir comunidad, dirigir tráfico y generar reconocimiento de marca.',
      'articulo 1 concepto 2 title': 'La Estrategia de Marketing: El Mapa, No el Territorio',
      'articulo 1 concepto 2 description': 'Una estrategia robusta debe incluir definición de objetivos, identificación del público, propuesta de valor, mensaje clave, selección de canales, plan de contenido y medición. Instagram es simplemente el vehículo, no el plan completo.',
      'articulo 1 concepto 3 title': 'Conclusión: Integración Estratégica',
      'articulo 1 concepto 3 description': 'Para maximizar el potencial de Instagram, es fundamental integrarlo como un componente valioso dentro de una estrategia de marketing holística, alineando esfuerzos con objetivos comerciales generales.',
      ...
      'articulo 2 introduction': 'En la era digital, la presión por tener una presencia activa en redes sociales es inmensa. Muchas empresas y emprendedores sienten que, sin perfiles en plataformas como Instagram, Facebook o TikTok, es imposible alcanzar el éxito comercial. Sin embargo, esta percepción es errónea. Este artículo explorará cómo es posible construir un negocio próspero y generar ventas significativas incluso sin una fuerte (o nula) presencia en redes sociales, destacando estrategias alternativas y el valor de un enfoque diversificado.',
      'articulo 2 concepto 1 title': 'Marketing de Contenidos y SEO',
      'articulo 2 concepto 1 description': 'Crear contenido de valor optimizado para motores de búsqueda que atraiga tráfico orgánico de usuarios buscando activamente soluciones relacionadas con tus productos o servicios.',
      'articulo 2 concepto 2 title': 'Email Marketing y Publicidad Pagada',
      'articulo 2 concepto 2 description': 'Construir una lista de suscriptores para comunicación directa y personalizada, complementada con publicidad pagada en motores de búsqueda para alcanzar usuarios con intención de compra.',
      'articulo 2 concepto 3 title': 'Networking y Marketing de Referencia',
      'articulo 2 concepto 3 description': 'Participar en eventos del sector y construir alianzas estratégicas, aprovechando el boca a boca y programas de referidos para generar ventas orgánicas.',
      ...
      'articulo 3 introduction': 'En un mercado cada vez más competitivo y saturado, la diferenciación a través del producto o precio se vuelve efímera. Es aquí donde el mercadeo relacional emerge como una estrategia fundamental. A diferencia del marketing transaccional, que se enfoca en la venta única, el mercadeo relacional busca construir y mantener relaciones duraderas y significativas con los clientes. Este artículo explorará los principios, beneficios y la implementación efectiva de esta poderosa filosofía empresarial.',
      'articulo 3 concepto 1 title': 'Pilares del Mercadeo Relacional',
      'articulo 3 concepto 1 description': 'Confianza, comunicación, compromiso, satisfacción y personalización como fundamentos para construir relaciones duraderas con los clientes.',
      'articulo 3 concepto 2 title': 'Beneficios Estratégicos',
      'articulo 3 concepto 2 description': 'Mayor retención, aumento del CLV, reducción de costos de adquisición, incremento de ventas y referencias, mejora de reputación y retroalimentación valiosa.',
      'articulo 3 concepto 3 title': 'Implementación Efectiva',
      'articulo 3 concepto 3 description': 'Uso de CRM, personalización de experiencias, canales de comunicación abiertos, servicio excepcional y programas de lealtad.',
      ...
      'articulo 4 introduction': 'En la era de la información, los datos se han convertido en el activo más valioso para cualquier negocio. Una base de datos bien estructurada y gestionada no es solo un repositorio de información, sino una herramienta estratégica que impulsa la toma de decisiones, optimiza operaciones y fomenta el crecimiento. Este artículo explorará por qué la base de datos es el cimiento de una estrategia empresarial exitosa y cómo su correcta utilización puede marcar la diferencia en la competitividad de una organización.',
      'articulo 4 concepto 1 title': 'Razones Clave de Importancia',
      'articulo 4 concepto 1 description': 'Toma de decisiones informada, personalización y segmentación, optimización de operaciones, fidelización de clientes, ventaja competitiva y cumplimiento normativo.',
      'articulo 4 concepto 2 title': 'Tipos de Datos y Aplicación',
      'articulo 4 concepto 2 description': 'Datos demográficos, de comportamiento, transaccionales y de interacción para análisis estratégico y personalización.',
      'articulo 4 concepto 3 title': 'Gestión Efectiva',
      'articulo 4 concepto 3 description': 'Calidad de datos, seguridad, integración, análisis y actualización constante para maximizar el valor de la información.',
      'articulo 5 title': 'La importancia de mutar',
      'articulo 5 subtitle': 'Adaptación como clave de supervivencia en el entorno digital',
      'articulo 5 introduction': 'En un mundo caracterizado por el cambio constante y acelerado, la capacidad de mutar no es solo una ventaja competitiva, sino una necesidad para la supervivencia de cualquier organización o individuo. El concepto de mutación, tomado de la biología, se refiere a la adaptación y transformación frente a nuevas condiciones. En el ámbito empresarial y personal, implica la flexibilidad para evolucionar, innovar y reinventarse. Este artículo explorará por qué la mutación es crucial en la actualidad y cómo cultivarla para prosperar en entornos dinámicos.',
      'articulo 5 concepto 1 title': 'Factores Impulsores',
      'articulo 5 concepto 1 description': 'Tecnología, consumidor, competencia, globalización y crisis como fuerzas que exigen adaptación constante.',
      'articulo 5 concepto 2 title': 'Cultivar la Capacidad de Mutación',
      'articulo 5 concepto 2 description': 'Mentalidad de aprendizaje, agilidad, innovación abierta, cultura de experimentación y visión adaptativa.',
      'articulo 5 concepto 3 title': 'Estrategias de Adaptación',
      'articulo 5 concepto 3 description': 'Diversidad, inclusión y escucha activa del entorno para mantener relevancia y valor.',
      ...
      'articulo 6 introduction': 'En el corazón de cualquier estrategia de marketing y ventas exitosa reside un profundo entendimiento del cliente. Sin embargo, muchas empresas cometen el error de lanzar productos o campañas sin haber definido claramente a quién se dirigen. Aquí es donde entra en juego el concepto del avatar de cliente (también conocido como buyer persona). Este artículo explicará por qué la creación de un avatar detallado es el primer paso y el más crucial para construir un negocio que resuene con su audiencia y genere resultados.',
      'articulo 6 concepto 1 title': 'Elementos Clave del Avatar',
      'articulo 6 concepto 1 description': 'Datos demográficos, psicográficos, comportamientos, objetivos, retos, objeciones y fuentes de información para una representación completa.',
      'articulo 6 concepto 2 title': 'Beneficios Fundamentales',
      'articulo 6 concepto 2 description': 'Claridad en marketing, desarrollo de productos relevantes, optimización de canales, mejora de experiencia y aumento de conversiones.',
      'articulo 6 concepto 3 title': 'Construcción Basada en Investigación',
      'articulo 6 concepto 3 description': 'Entrevistas, encuestas, análisis de datos, investigación de mercado y observación para crear un avatar informado.',
    },
    home: {
  ...
  en: {
    ...
    blog: {
      ...
      'articulo 1 introduction': 'In the current digital landscape, Instagram has established itself as one of the most influential social media platforms. However, there is a common confusion among many businesses and entrepreneurs: considering Instagram as a marketing strategy in itself. This article will break down why Instagram, and in fact any social network, should be seen as a channel within a broader marketing strategy, and not as the complete strategy.',
      'articulo 1 concepto 1 title': 'Instagram as a Communication and Distribution Channel',
      'articulo 1 concepto 1 description': 'Instagram offers powerful tools for visual communication, audience interaction, and content distribution. It allows showcasing products, building community, driving traffic, and generating brand recognition.',
      'articulo 1 concepto 2 title': 'Marketing Strategy: The Map, Not the Territory',
      'articulo 1 concepto 2 description': 'A robust strategy must include objective definition, audience identification, value proposition, key messaging, channel selection, content planning, and measurement. Instagram is simply the vehicle, not the complete plan.',
      'articulo 1 concepto 3 title': 'Conclusion: Strategic Integration',
      'articulo 1 concepto 3 description': 'To maximize Instagram\'s potential, it is essential to integrate it as a valuable component within a holistic marketing strategy, aligning efforts with overall business objectives.',
      ...
      'articulo 2 introduction': 'In the digital era, the pressure to have an active presence on social media is immense. Many businesses and entrepreneurs feel that without profiles on platforms like Instagram, Facebook, or TikTok, it\'s impossible to achieve commercial success. However, this perception is mistaken. This article will explore how it\'s possible to build a prosperous business and generate significant sales even without a strong (or null) presence on social media, highlighting alternative strategies and the value of a diversified approach.',
      'articulo 2 concepto 1 title': 'Content Marketing and SEO',
      'articulo 2 concepto 1 description': 'Create valuable content optimized for search engines that attracts organic traffic from users actively seeking solutions related to your products or services.',
      'articulo 2 concepto 2 title': 'Email Marketing and Paid Advertising',
      'articulo 2 concepto 2 description': 'Build a subscriber list for direct and personalized communication, complemented with paid advertising on search engines to reach users with purchase intent.',
      'articulo 2 concepto 3 title': 'Networking and Referral Marketing',
      'articulo 2 concepto 3 description': 'Participate in industry events and build strategic alliances, leveraging word-of-mouth and referral programs to generate organic sales.',
      ...
      'articulo 3 introduction': 'In an increasingly competitive and saturated market, differentiation through product or price becomes ephemeral. This is where relationship marketing emerges as a fundamental strategy. Unlike transactional marketing, which focuses on single sales, relationship marketing seeks to build and maintain lasting and meaningful relationships with customers. This article will explore the principles, benefits, and effective implementation of this powerful business philosophy.',
      'articulo 3 concepto 1 title': 'Pillars of Relationship Marketing',
      'articulo 3 concepto 1 description': 'Trust, communication, commitment, satisfaction, and personalization as foundations for building lasting relationships with customers.',
      'articulo 3 concepto 2 title': 'Strategic Benefits',
      'articulo 3 concepto 2 description': 'Greater retention, increased CLV, reduced acquisition costs, increased sales and referrals, improved reputation, and valuable feedback.',
      'articulo 3 concepto 3 title': 'Effective Implementation',
      'articulo 3 concepto 3 description': 'Use of CRM, personalized experiences, open communication channels, exceptional service, and loyalty programs.',
      'articulo 4 title': 'The importance of the database',
      'articulo 4 subtitle': 'The most valuable asset of any modern business',
      'articulo 4 introduction': 'In the information age, data has become the most valuable asset for any business. A well-structured and managed database is not just a repository of information, but a strategic tool that drives decision-making, optimizes operations, and fosters growth. This article will explore why the database is the foundation of a successful business strategy and how its proper use can make the difference in an organization\'s competitiveness.',
      'articulo 4 concepto 1 title': 'Key Reasons for Importance',
      'articulo 4 concepto 1 description': 'Informed decision-making, personalization and segmentation, operations optimization, customer loyalty, competitive advantage, and regulatory compliance.',
      'articulo 4 concepto 2 title': 'Data Types and Application',
      'articulo 4 concepto 2 description': 'Demographic, behavioral, transactional, and interaction data for strategic analysis and personalization.',
      'articulo 4 concepto 3 title': 'Effective Management',
      'articulo 4 concepto 3 description': 'Data quality, security, integration, analysis, and constant updates to maximize information value.',
      ...
      'articulo 5 concepto 1 title': 'Driving Factors',
      'articulo 5 concepto 1 description': 'Technology, consumer, competition, globalization, and crises as forces demanding constant adaptation.',
      'articulo 5 concepto 2 title': 'Cultivating Mutation Capacity',
      'articulo 5 concepto 2 description': 'Learning mindset, agility, open innovation, experimentation culture, and adaptive vision.',
      'articulo 5 concepto 3 title': 'Adaptation Strategies',
      'articulo 5 concepto 3 description': 'Diversity, inclusion, and active environmental listening to maintain relevance and value.',
      'articulo 6 title': 'First build your avatar',
      'articulo 6 subtitle': 'The essential initial step for any successful campaign',
      'articulo 6 introduction': 'At the heart of any successful marketing and sales strategy lies a deep understanding of the customer. However, many companies make the mistake of launching products or campaigns without clearly defining who they are targeting. This is where the concept of customer avatar (also known as buyer persona) comes into play. This article will explain why creating a detailed avatar is the first and most crucial step to building a business that resonates with its audience and generates results.',
      'articulo 6 concepto 1 title': 'Key Avatar Elements',
      'articulo 6 concepto 1 description': 'Demographic, psychographic, behavioral, goals, challenges, objections, and information sources for a complete representation.',
      'articulo 6 concepto 2 title': 'Fundamental Benefits',
      'articulo 6 concepto 2 description': 'Marketing clarity, relevant product development, channel optimization, experience improvement, and increased conversions.',
      'articulo 6 concepto 3 title': 'Research-Based Construction',
      'articulo 6 concepto 3 description': 'Interviews, surveys, data analysis, market research, and observation to create an informed avatar.',
    },
    home: {
